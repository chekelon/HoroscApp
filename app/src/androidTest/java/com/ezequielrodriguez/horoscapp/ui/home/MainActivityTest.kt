package com.ezequielrodriguez.horoscapp.ui.home
...
import com.ezequielrodriguez.horoscapp.ui.detail.HoroscopeDetailActivity
...
class MainActivityTest{
    ...
    fun when_horoscope_is_selected_then_open_detail(){
        onView(withId(R.id.rsHoroscope)).perform(RecyclerViewActions.actionOnItemAtPosition<RecyclerView.ViewHolder>(0,
            click()
        ))
